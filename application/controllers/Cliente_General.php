...
class Cliente_General extends Custom_Controller
{
  ...
  /*----------------------------------------*/
    ...
    public function get_candidates()
    {
        ...
        $result = $this->cliente_general_model->get_candidates($start, $length, $search, $id_cliente);
        $total  = $this->cliente_general_model->get_total($search, $id_cliente);
    ...
    //
    public function getCandidatosFinalizados()
    {
        $id_cliente              = $_GET['id'];
    ...
    public function getCandidatosUltimosFinalizados()
    {
        $id_cliente              = $_GET['id'];
    ...
    public function getCandidatosUltimos100()
    {
        $id_cliente              = $_GET['id'];
        $statusBGC               = (isset($_GET['enproceso']) && $_GET['enproceso'] == 0) ? [0, 1, 2, 3, 4, 5] : [0];
        $cand['recordsTotal']    = $this->cliente_general_model->getTotalUltimos100($id_cliente, $this->session->userdata('idrol'), $this->session->userdata('id'), $statusBGC);
        $cand['recordsFiltered'] = $this->cliente_general_model->getTotalUltimos100($id_cliente, $this->session->userdata('idrol'), $this->session->userdata('id'), $statusBGC);
    ...
    public function getInvestigacionLegal()
    {
        $id_candidato = $this->input->post('id_candidato');
        $res          = [];
    ...
    public function getComentariosRefPersonales()
    {
        $id_candidato = $this->input->post('id_candidato');
        $salida       = "";
    ...
    public function countAntecedentesLaborales()
    {
        $id_candidato = $this->input->post('id_candidato');
    ...
    public function getComentariosRefVecinales()
    {
        $id_candidato = $this->input->post('id_candidato');
        $salida       = "";
    ...
    public function getInformacionVisita()
    {
        $id_candidato   = $this->input->post('id_candidato');
    ...
    public function getUsuariosClientePrivados()
    {
  ...
  /*----------------------------------------*/
    public function registrar()
    {
        if ($this->input->post('previo') != 0) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $id_puesto          = ! empty($this->input->post('puesto')) ? $this->input->post('puesto') : null;
    ...
    public function guardarDatosGeneralesInternacionales()
    {
        $this->form_validation->set_rules('nombre', 'Nombre', 'required|trim');
        $this->form_validation->set_rules('paterno', 'Primer apellido', 'required|trim');
        $this->form_validation->set_rules('materno', 'Segundo apellido', 'trim');
    ...
    public function guardarHistorialAcademico()
    {
    ...
    public function guardarAntecendentesSociales()
    {
    ...
    public function guardarAntecedenteLaboral()
    {
    ...
    public function guardarInvestigacionLegal()
    {
    ...
    public function actualizarProcesoCandidato()
    {
        date_default_timezone_set('America/Mexico_City');
        $date         = date('Y-m-d H:i:s');
    ...
    public function guardarIntegranteFamiliar()
    {
        $this->form_validation->set_rules('nombre', 'Nombre', 'required|trim');
    ...
    public function editarExtrasCandidato()
    {
    ...
    public function guardarReferenciasVecinales()
    {
        $this->form_validation->set_rules('nombre', 'Nombre', 'required|trim');

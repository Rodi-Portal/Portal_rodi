...
class Cliente extends CI_Controller
{
    ...
    public function getCandidatosCliente()
    {
    ...
    public function getCandidatosSubclientes()
    {
    ...
    public function guardarCandidatoExpress()
    {
        $id_cliente    = $this->input->post('id_cliente');
        $nombre        = strtoupper($this->input->post('nombre'));
        $cel           = $this->input->post('celular');
    ...
    public function getControlesById()
    {
        $res = $this->cliente_control_model->getById($this->input->post('id_cliente'));
        echo json_encode($res);
    }

    public function get_requisicion_details()
    {
    ...
    public function get_data()
    {
        ...
        foreach ($candidatosData as $c) {
            ...
            $data[] = [$c->candidato, $nombreProceso, $fecha_alta, $icono_mensajes, $examenes, $c->status_bgc];
        }

...
<div class="container-fluid">
  ...
  <section class="content-header mb-5">
    <h1 class="titulo_seccion">
      <?php echo t('reportes_clientes_title', 'Reporte de Registros de Clientes'); ?>
    </h1>
  </section>
  ...
  <div class="container">
    <form id="filtros">
      <div class="row">
        <div class="col-md-8 offset-2">
          <label>
            <?php echo t('reportes_clientes_sucursal', 'Sucursal *'); ?>
          </label>
          <select name="cliente" id="cliente" class="form-control">
            <option value="">
              <?php echo t('reportes_clientes_select', 'Selecciona'); ?>
            </option>
            <option value="0">
              <?php echo t('reportes_clientes_all', 'TODOS'); ?>
            </option>
    ...
    <div class="row mt-3 mb-5">
      <div class="col-4 offset-5">
        <a href="javascript:void(0)" class="btn btn-primary" onclick="consultar()">
          <?php echo t('reportes_clientes_btn_consultar', 'Consultar'); ?>
        </a>
        <br>
      </div>
    </div>
    ...
    <div id="div_reporte">
      <h2>
        <?php echo t('reportes_clientes_resultados', 'Datos consultados:'); ?>
      </h2>

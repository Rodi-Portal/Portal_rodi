...
<script>
  ...
  // Obtén el valor del switch (1 si está marcado, null si no lo está)
  let tipoUsuarioSwitch = document.getElementById("tipoUsuarioSwitch");
  let tipoUsuarioValue = tipoUsuarioSwitch.checked ? 1 : 0;

  // Serializa los datos del formulario y agrega el valor de tipo_usuario
  let datos = $('#formAccesoCliente').serialize() + '&tipo_usuario=' + tipoUsuarioValue;

              ...
              <div class="card-body">
                ...
                <div class="collapse" id="collapseRegistroRequisicion">
                  ...
                  <ul>
                    ...
                    <li class="mt-5 mb-5"><b>INTERNA:</b> Es una forma más rápida de registrar una requisición ya que el formulario solo tiene los campos necesarios para un registro básico. Este formulario se ubica dando clic al botón "Nueva requisición" ubicado dentro de la vista del apartado de Requisiciones: <img src="<?php echo base_url().'manuales/usuario/reclutamiento/btn_nueva_requisicion.png'?>" width="10%"><br>Para registrar una requisición INTERNA se deberán llenar los campos obligatorios de cada paso del formulario.</li>
                    <div class="row">
                ...
                <div class="collapse" id="collapseTarjetaRequisicion">
                  ...
                  <ul>
                    ...
                    <li class="mb-5">5) Indica el tipo de requisición, si es <b>COMPLETA</b> o si es <b>INTERNA</b>.</li>

        ...
        <div class="container-fluid">
            <ul class="navbar-nav">
                <li class="nav-item reclutamiento empleados-header-button-container">
                    <a class="custom-link empleados-header-button empleados-header-button-active" href="<?php echo site_url('Reclutamiento/requisicion'); ?>">Mi escritorio</a>
                </li>
                <li class="nav-item reclutamiento empleados-header-button-container">
                    <a class="custom-link empleados-header-button" href="<?php echo site_url('Reclutamiento/control'); ?>">Requisiciones en proceso</a>
                </li>
                <li class="nav-item reclutamiento empleados-header-button-container">
                    <a class="custom-link empleados-header-button" href="<?php echo site_url('Reclutamiento/finalizados'); ?>">Requisiciones Finalizadas</a>
                </li>
                <li class="nav-item reclutamiento empleados-header-button-container">
                    <a class="custom-link empleados-header-button" href="<?php echo site_url('Reclutamiento/bolsa'); ?>">Aspirantes</a>
                </li>
            </ul>
        </div>
    </nav>

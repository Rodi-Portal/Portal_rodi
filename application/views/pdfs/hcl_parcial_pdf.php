...
<body>
  ...
  if($ver_documento){
	...
	<!-- Datos Personales -->
  <?php 
  if($secciones->id_seccion_datos_generales == 111 && !empty($nacionalidad)){ ?>
    <div class="div_datos">
  ...
  if($secciones->id_seccion_datos_generales == 83 && !empty($nacionalidad)){ ?>
    <div class="div_datos">
      <p class="center f-18">Personal Data</p>
      <table class="">
        <tr>
  ...
  <?php 
   ...
   <!-- Referencias Academicas -->
	<?php 
  if($secciones->cantidad_ref_academicas > 0){
    if($ref_academicas){ 
  ...
  <!-- Domicilios -->
	<?php 
	if($secciones->lleva_domicilios == 1 && !empty($domicilios)){ ?>
		<div class="div_datos">
  ...
  <!-- GAPS -->
  <?php 
  if($secciones->lleva_gaps == 1 && !empty($gaps)){ ?>
    <div class="div_datos">
  ...
  <!-- Separador de hoja -->
  <?php 
  if($secciones->cantidad_ref_profesionales > 2){
    echo '<pagebreak>';
  } ?>

  <!-- Referencias Profesionales -->
	<?php 
  if($secciones->cantidad_ref_profesionales > 0 && !empty($ref_profesional)){
    if($ref_profesional){ 
      $num = 0; ?>
      <div class="div_datos">
  ...
  <!-- Referencias Personales -->
	<?php 
  if($secciones->cantidad_ref_personales > 0 && !empty($ref_personales)){
    if($ref_personales){ 
      $num = 0; ?>
      <div class="div_datos">
  ...
  <!-- Records Criminales -->
  <?php
  if($secciones->lleva_criminal == 1 && !empty($fecha_ver_penales) && !empty($det_penales)){ 

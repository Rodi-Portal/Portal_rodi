 ...
 <!--pre>
  ...
  <table class="table">
    ...
    <tr>
      ...
      <td colspan="3">Actividades: <b><?php echo $actividades ?></b></td>
    </tr>
  </table>
  ...
  <table class="table">
    <tr>
      <td class="titulo_seccion centrado" colspan="2">Datos de facturación</td>
    </tr>
    <tr>
    ...
    <tr>
      <?php	$rfc = (empty($requisicion->rfc))? 'No registrado' : $requisicion->rfc; ?>
      <td colspan="2">RFC: <b><?php echo $rfc ?></b></td>
    </tr>
    <tr>
      <?php $forma_pago = $requisicion->forma_pago ?? 'No registrado'; ?>
      <td>Forma de pago: <b><?php echo $forma_pago ?></b></td>
      <?php $metodo_pago = $requisicion->metodo_pago ?? 'No registrado'; ?>
      <td>Método de pago: <b><?php echo $metodo_pago ?></b></td>
    </tr>
    <tr>
      <?php $regimen = $requisicion->regimen ?? 'No registrado'; ?>
      <td colspan="2">Régimen fiscal: <b><?php echo $regimen ?></b></td>
    </tr>
    <tr>
      <?php $uso_cfdi = $requisicion->uso_cfdi ?? 'No registrado'; ?>
      <td colspan="2">Uso de CFDI: <b><?php echo $uso_cfdi ?></b></td>
    </tr>
    <tr>

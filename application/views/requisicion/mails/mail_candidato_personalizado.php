      ...
      <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:600px;max-width:600px;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
        <tr>
          <td class="container-padding header" align="center" style="padding-bottom:12px;color:#DF4726;padding-left:24px;padding-right:24px; border-collapse: collapse;">
            <img src="https://i.ibb.co/64Y3SqK/logo-rts.png" alt="REMOTE TEAM SOLUTIONS" style="-ms-interpolation-mode: bicubic;" width="250px" height="200px">
          </td>
        </tr>
        <tr>
          <td class="container-padding content" align="left" style="padding-left:24px;padding-right:24px;padding-top:7px;padding-bottom:12px;background-color:#ffffff; border-collapse: collapse;">
            ...
            <div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:black;">
              This mail has been sent from <?php echo $cliente; ?> to register your data in this <a href="http://rodicontrol.rodi.com.mx">form</a>.
              <br><br>
              ...
              <br><br>
              Please answer this form as soon as possible. If you experience any problem to access or while filling the form, please let us know, and we will gladly help you. vgonzalez@rodicontrol.com
            </div>

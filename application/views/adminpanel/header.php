			...
			if(in_array(9, $submenus)){ ?>
              ...
              if(in_array(27, $submenus)){ ?>
							...
							if(in_array(26, $submenus)){ ?>
								<a class="collapse-item contraer" data-toggle="tooltip" data-placement="right" title="Doping Finalizados" href="<?php echo site_url('Reporte/listado_clientes_index') ?>">Doping Finalizados</a>
							<?php
							}*/

        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="tabla" class="table table-hover table-bordered" id="dataTable" width="100%"
                        cellspacing="0">
                    </table>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $("#filtroListado").change(function() {
        ...
        if (opcion == 1) {
            ...
            urlFiltrada = '<?php echo base_url('Cliente_General/getCandidatos?id='); ?>' + id +
                '&enproceso=' + 1;
        ...
        if (opcion == 3) {
            $('#tabla').DataTable().destroy();
            urlFiltrada =
                '<?php echo base_url('Cliente_General/getCandidatosUltimosFinalizados?id='); ?>' + id
            changeDatatable(urlFiltrada);
        }
        if (opcion == 4) {
            $('#tabla').DataTable().destroy();
		...
		if (opcion == 5) {
            $('#tabla').DataTable().destroy();
            urlFiltrada = '<?php echo base_url('Cliente_General/getCandidatosUltimos100?id='); ?>' + id +
                '&enproceso=' + 0;
            changeDatatable(urlFiltrada);
        }
    });
